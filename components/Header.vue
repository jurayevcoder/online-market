<template>
  <header class="fixed z-50 w-full">
    <div class="container mx-auto px-4 ">
      <nav class="border-gray-200 border-b lg:px-6 py-2.5">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <form>
            <div class="flex border-2 border-blue-500 rounded-lg w-[665px]">
              <div class="relative w-full flex items-center">
                <input
                  type="search"
                  id="search-dropdown"
                  class="block p-2.5 w-full z-20 text-sm text-gray-900 rounded-l-lg bg-gray-50 outline-none"
                  placeholder="Search..."
                  required
                />
                <button
                ...
                <button
                  type="submit"
                  class="p-2.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg hover:bg-blue-800 w-[150px]"
                >
          ...
          >
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li class="flex flex-col justify-center items-center text-[#8B96A5] hover:text-blue-500">
              ...
              <NuxtLink to="/cart" class="flex flex-col justify-center items-center text-[#8B96A5] hover:text-blue-500">
      ...
      <nav class="border-gray-200 border-b lg:px-6 py-3">
        <div
          class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl pr-10"
        >
